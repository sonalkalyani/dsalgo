...
#When The user select Linked List from the DataStructure dropdown menu
#Then The user shoulde be redirected to Linked List page.
...
When The user clicks the "Run" button after writes valid python code in editor
