...
//	}
	...
	public void user_is_on_page(String dataStructureName, String topicPageName) throws InterruptedException {
		commonobj.login();
		commonobj.clickGetStartedButtonCommon(dataStructureName);
		commonobj.clickdataStructuresHomeLinks(topicPageName);
	...
	public void the_user_tries_to_click_on_links_on_the_left_panel() throws URISyntaxException {
		...
		LOG.info("All links has been verified");
